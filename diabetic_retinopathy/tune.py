...
def train_func(config):
    ...
    # gin-config
    gin.parse_config_files_and_bindings(['/Users/rocker/dl-lab-22w-team06/diabetic_retinopathy/configs/config.gin'], bindings) # change path to absolute path of config file
